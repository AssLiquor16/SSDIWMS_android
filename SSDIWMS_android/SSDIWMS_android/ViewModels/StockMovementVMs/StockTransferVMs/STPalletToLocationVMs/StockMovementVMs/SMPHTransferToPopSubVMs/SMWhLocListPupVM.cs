...
namespace SSDIWMS_android.ViewModels.StockMovementVMs.StockTransferVMs.STPalletToLocationVMs.StockMovementVMs.SMPHTransferToPopSubVMs
{
    public class SMWhLocListPupVM : ViewModelBase
    {
